  ...
  return (
    <div className="me-help">
      ...
      <div className="me-help__section-text">
        Get 10 Green counts a day and earn green check mark
      </div>
      ...
      <div className="me-help__section-text">
        Get 3 days with check marks - add a green star to your calendar
      </div>
      ...
      <div className="me-help__section-text">
        Get 3 days with green stars - add a gold star to your calendar
      </div>
    </div>
  );
};
